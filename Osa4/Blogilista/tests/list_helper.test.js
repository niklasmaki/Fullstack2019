...
describe('total likes', () => {
  ...
  test('of list with one blog is the number of likes in that blog', () => {
  ...
  test('of a list with multiple blogs is calculated correctly', () => {
    expect(listHelper.totalLikes(listWithMultipleBlogs)).toBe(24)
  })
})
...
describe('most blogs', () => {
  ...
  test('of a list with one blog is the writer of that blog', () => {
